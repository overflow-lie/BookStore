!function(t, e, a, n) {
    ...
    t.extend(i.prototype, {
        ...
        checkout: function() {
            ...
            i.attr("action", "/BookStore/cart/list"),
            i.attr("method", "post");
            for (var s in n)
                e = t('<input type="text" />'),
                e.attr("name", s),
        ...
        remove_item: function(e) {
            ...
            t("." + a.settings.cart + "-remove").unbind().on("click", function() {
                ...
                a.calculate_total_value(),
                a.storage_set(),
                1 === n && (a.remove_cart_buttons(),
                a.remove_total(a.total),
                a.storage_clear()),
        ...
        permanent_total: function() {
            ...
            "true" === t.settings.display_total_value && t.total.html("true" === t.settings.currency_after_number ? "0" + t.settings.currency : t.settings.currency + "0"))
        },
